...
namespace ASP.NET_CORE_Final_2019.API_NganLuong
{
    public class APICheckoutV3
    {
        public IConfiguration configuration { get; }
        public APICheckoutV3(IConfiguration _configuration)
        {
            configuration = _configuration;
        }
        public ResponseInfo GetUrlCheckout(RequestInfo requestContent, string payment_method ="ATM_ONLINE")
        {
